...
export const loadUser = (login, requiredFields = []) => (dispatch, getState) => {
  ...
  if (user && requiredFields.every(key => user.hasOwnProperty(key))) { // eslint-disable-line
    return null;
  }
...
export const loadRepo = (fullName, requiredFields = []) => (dispatch, getState) => {
  ...
  if (repo && requiredFields.every(key => repo.hasOwnProperty(key))) { // eslint-disable-line
    return null;
  }
